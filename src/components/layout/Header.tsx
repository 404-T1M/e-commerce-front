...
function MobileMenu({
  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      <div
        className={cn(
          "absolute top-0 bottom-0 w-64 bg-sidebar flex flex-col animate-slide-in",
        ...
        <div className="border-t border-sidebar-border p-3 space-y-2">
          {admin && (
            <Link
              to="/admin/profile"
              onClick={onClose}
              className="block px-2 py-1 mb-2 hover:bg-slate-800 rounded-lg transition-colors"
            >
...
export function Header() {
  ...
  const navGroups: MobileNavGroup[] = [
    ...
    },
    {
      ...
      items: [
        {
          to: "/admin/analytics/profit-reports",
          icon: TrendingUp,
          label: copy.profitReports,
        },
        {
          to: "/admin/analytics/user-reports",
          icon: Users,
          label: copy.customerReports,
        },
        {
          to: "/admin/analytics/product-reports",
          icon: Package,
          label: copy.productReports,
        },
        {
          to: "/admin/analytics/coupon-reports",
          icon: Ticket,
          label: copy.couponReports,
        },
      ],
    },
    {
          ...
          {admin && (
            ...
            >
              <Avatar
                ...
                src={
                  admin.profileImage
                    ? (admin.profileImage as any).imageUrl ||
                      (admin.profileImage as any).url
                    : null
                }
              />
